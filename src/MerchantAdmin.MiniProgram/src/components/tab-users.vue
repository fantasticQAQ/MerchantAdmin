  ...
  <view class="page">
    ...
    <view class="user-list">
      <view v-for="item in list" :key="item.id" class="user-card">
        <view class="user-main">
          ...
          <view v-if="item.email" class="user-email">{{ item.email }}</view>
    ...
    <view v-if="createVisible" class="mask" @click="createVisible = false">
      <view class="dialog" @click.stop>
        ...
        <view class="form-item">
          ...
          <input class="input" v-model="createForm.email" placeholder="邮箱（可选）" />
        </view>
        <view class="form-item">
    ...
    <view v-if="editVisible" class="mask" @click="editVisible = false">
      <view class="dialog" @click.stop>
        ...
        <view class="form-item">
          <text class="label">邮箱</text>
          <input class="input" v-model="editForm.email" placeholder="邮箱（可选）" />
        </view>
        <view class="role-select">
          <text class="role-select-title">分配角色</text>
...
const onReachBottom = () => { /* 用户列表无分页 */ }

// 下拉刷新：同时刷新用户与角色列表
const refresh = () => Promise.all([fetchUsers(), fetchRoles()])
